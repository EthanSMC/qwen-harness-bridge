...
- Repository-wide reconciliation that explicitly reports and isolates closed pre-lifecycle history with zero lifecycle labels while preserving fail-closed validation for any Issue that entered the managed state machine.

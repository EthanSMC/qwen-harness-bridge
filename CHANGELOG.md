...
- Strict AI lifecycle activation with an immutable protected-main activation commit, empty migration registry, null acceptance window, both repository gates enforced, and a fresh post-activation smoke claim.
